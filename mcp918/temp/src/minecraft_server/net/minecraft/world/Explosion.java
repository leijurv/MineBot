...
public class Explosion {
   ...
   private final Map<EntityPlayer, Vec3> field_77288_k = Maps.<EntityPlayer, Vec3>newHashMap();
      ...
      if(this.field_82755_b) {
         for(BlockPos blockpos : this.field_77281_g) {
            ...
            if(p_77279_1_) {
               ...
               d4 = d4 * d7;
               d5 = d5 * d7;
               this.field_77287_j.func_175688_a(EnumParticleTypes.EXPLOSION_NORMAL, (d0 + this.field_77284_b * 1.0D) / 2.0D, (d1 + this.field_77285_c * 1.0D) / 2.0D, (d2 + this.field_77282_d * 1.0D) / 2.0D, d3, d4, d5, new int[0]);
